...
public interface LadyConstants {
    ...
    double DAMAGE_OF_BULLET = 8.0;
    long REMOVE_BULLET_AFTER = 120L; //removeBullet after some seconds after shoot 20L - 1s
    ...
    int DELAY_AFTER_ULTA = 105; //SECONDS after ulta how mich time do need to refresh ult

    //FLYING ABILITY
    int FLY_COUNTER = 7;
    long FLY_TIME = 400L;
    int COOLDOWN_FLY = 40; //SECONDS

    //TRAP
    double DETECT_RADIUS = 3; //detect enemy within radius
    ...
    double DAMAGE_AMOUNT_SE = 26.0; // Amount of damage dealt to entities
    //20damage = 5 hearts
    boolean DAMAGE_TERRAIN_SE = true; // Set to true if you want terrain damage
    int DELAY_PERK_SE = 60; //Seconds
