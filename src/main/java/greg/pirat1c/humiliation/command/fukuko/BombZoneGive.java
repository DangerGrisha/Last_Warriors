...
public class BombZoneGive implements CommandExecutor {
    private static final Material material = Material.REDSTONE; // Change to CROSSBOW
    ...
    public static ItemStack getChargedCrossbow() {
        ItemStack redstone = new ItemStack(material, 1);
        CrossbowMeta meta = (CrossbowMeta) redstone.getItemMeta(); // Cast to CrossbowMeta

        if (meta != null) {
            meta.setDisplayName(displayName);
            meta.setUnbreakable(true);
            meta.setLore(Collections.singletonList("Last Zoneee"));
